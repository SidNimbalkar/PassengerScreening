# Using GridSearchCV to automate the tuning process of the model. Different parameters will be tried and best
# performance will be evaluated. The file returns the model with the best parameters and best score.
